...
[Command]
name = "Salto Agarre corto"
command = ~F,D,DF, a
time = 25

[Command]
name = "Salto Agarre largo"
command = ~F,D,DF, b
time = 25
...
;===================================================================================
;Saibamanes Rush
[State -1, Saibamanes Rush]
type = ChangeState
value = 3200
triggerall = command = "Saibamanes Rush"
...
;Poison Blast
[State -1, Poison Blast]
type = ChangeState
value = 3000
triggerall = command = "Poison Blast"
...
;Autodestruirse
[State -1, Autodestruirse]
type = ChangeState
value = 3100
triggerall = command = "Autodestruirse"
triggerall = power >= 1000
...
trigger11 = (stateno = 300) && (movecontact = 1)


;Bola Venenosa en el aire
[State -1, Bola Venenosa en el aire]
type = ChangeState
value = 2100
triggerall = numhelper(2050) = 0
triggerall = numhelper(2051) = 0
...
trigger13 = (stateno = 1251) && (movecontact = 1)
trigger14 = (stateno = 1300)
trigger15 = (stateno = 1310)
...
;Explosi de Ki
[State -1, Explosi de Ki]
type = ChangeState
value = 2300
triggerall = power >= 200
triggerall = command = "Explosi de Ki"
trigger1 = ctrl = 1
trigger1 = statetype != A
trigger2 = (stateno = 200) && (movecontact = 1)
trigger3 = (stateno = 201) && (movecontact = 1)
...
;Bolita Devil
[State -1, Bolita Devil]
type = ChangeState
value = 1200
triggerall = command = "Bolita Devil"
trigger1 = ctrl
trigger1 = statetype = S
trigger2 = (stateno = 200) && (movecontact = 1)
trigger3 = (stateno = 201) && (movecontact = 1)
...
;Bolita Fuerte
[State -1, Bolita Fuerte]
type = ChangeState
value = 1250
triggerall = command = "Bolita Fuerte"
trigger1 = ctrl
trigger1 = statetype = S
trigger2 = (stateno = 200) && (movecontact = 1)
trigger3 = (stateno = 201) && (movecontact = 1)
...
;Garrazo Devil
[State -1, Garrazo Devil]
type = ChangeState
value = 1300
triggerall = command = "Garrazo Devil"
trigger1 = ctrl
trigger1 = statetype != A
trigger2 = (stateno = 200) && (movecontact = 1)
trigger3 = (stateno = 201) && (movecontact = 1)
...
;Garrazo Fuerte
[State -1, Garrazo Fuerte]
type = ChangeState
value = 1310
triggerall = command = "Garrazo Fuerte"
trigger1 = ctrl
trigger1 = statetype != A
trigger2 = (stateno = 200) && (movecontact = 1)
trigger3 = (stateno = 201) && (movecontact = 1)
...
trigger12 = stateno = 1350 ;Air blocking
trigger13 = (stateno = 1251) && (movecontact = 1)
trigger14 = (stateno = 1300) && time > 10
trigger15 = (stateno = 1310) && time > 10

;Garrazo Fuerte Aire
[State -1, Garrazo Fuerte Aire]
type = ChangeState
value = 1330
triggerall = command = "Garrazo Fuerte"
trigger1 = ctrl
...
;Salto Agarre corto
[State -1, Salto Agarre corto]
type = ChangeState
value = 1400
triggerall = command = "Salto Agarre corto"
trigger1 = ctrl
trigger1 = statetype = S
trigger2 = (stateno = 200) && (movecontact = 1)
trigger3 = (stateno = 201) && (movecontact = 1)
...
;Salto Agarre largo
[State -1, Salto Agarre largo]
type = ChangeState
value = 1410
triggerall = command = "Salto Agarre largo"
trigger1 = ctrl
trigger1 = statetype = S
trigger2 = (stateno = 200) && (movecontact = 1)
trigger3 = (stateno = 201) && (movecontact = 1)
...
trigger10 = (stateno = 440)  && (movecontact = 1)
trigger11 = (stateno = 300) && (movecontact = 1)
trigger6 = (stateno = 1251) && (movecontact = 1)
...
type = ChangeState
value = 1500
triggerall = command = "Enterrarse 1" || command = "Enterrarse 2"
trigger1 = ctrl
trigger1 = statetype = S

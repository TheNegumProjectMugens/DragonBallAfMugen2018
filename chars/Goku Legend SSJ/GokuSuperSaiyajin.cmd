...
type = ChangeState
value = 3000
triggerall = command = "superkamehameha"
trigger1 = statetype != A
trigger1 = ctrl
trigger1 = power >= 1500
;---------------------------------------------------------------------------
...
;---------------------------------------------------------------------------
;combos
[State -1, multi combos]
type = ChangeState
value = 420
triggerall = command = "combos"
triggerall = command != "holddown"
trigger1 = statetype = S
trigger1 = ctrl
;---------------------------------------------------------------------------
...
[State -1]
type = ChangeState
value = 777 ; valor del statedef de el charge en el cns

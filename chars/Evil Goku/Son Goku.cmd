...
[command]
name = "Zanzouken Supa Kick"
command = D,B,a+b
time = 20

[command]
name = "Zanzouken S Kick"
command = D,B,x+y
time = 20

[command]
name = "Zanzouken Kick air"
command = D,F,y
time = 20
...
;Genki Dama Ball
[State -1, Genki Dama Ball]
type = ChangeState
value = 1030
triggerall = command = "Genki Dama Ball"
triggerall = var(40) != 1
...
;---------------------------------------------------------------------------
; Zankouken Kameha Air
[State -1, Zankouken Kameha Air]
type = ChangeState
value = 2010
triggerall = command = "Zankouken Kameha Air"
trigger1 = (statetype = S) && ctrl
...
;---------------------------------------------------------------------------
; Zanzouken Supa Kick
[State -1, Zanzouken Supa Kick]
type = ChangeState
value = 607
triggerall = command = "Zanzouken Supa Kick"
triggerall = power >= 200
trigger1 = (statetype = S) && ctrl
trigger1 = ctrl = 1
...
;---------------------------------------------------------------------------
; Zanzouken S Kick
[State -1, Zanzouken S Kick]
type = ChangeState
value = 606
triggerall = command = "Zanzouken S Kick"
triggerall = power >= 200
trigger1 = (statetype = S) && ctrl
trigger1 = ctrl = 1
...
;---------------------------------------------------------------------------
; Zanzouken Kick air
[State -1, Zanzouken Kick air]
type = ChangeState
value = 605
triggerall = command = "Zanzouken Kick air"
triggerall = power >= 200
...
type = ChangeState
value = 604
triggerall = command = "Zanzouken punch stand"
triggerall = power >= 200
trigger1 = (statetype = S) && ctrl
trigger1 = ctrl = 1
...
triggerall = stateno != 2995
triggerall = power >= 4000
triggerall = command = "Quick Turn SSJ"
trigger1 = (statetype = s) && ctrl
trigger1 = ctrl = 1
...
;---------------------------------------------------------------------------
; S Strong Punch
[State -1, S Strong Punch]
type = ChangeState
value = 602
triggerall = command = "S Strong Punch"
trigger1 = (statetype = S) && ctrl
...
type = ChangeState
value = 212
triggerall = command = "Vel punch"
trigger1 = (statetype = S) && ctrl

;---------------------------------------------------------------------------
; Vel kick fwd b
[State -1, Vel kick fwd b]
type = ChangeState
value = 232
triggerall = command = "Vel kick fwd b"
trigger1 = (statetype = S) && ctrl
